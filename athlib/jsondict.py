...
class JSONDict(dict):
    ...
    def __getattr__(self, attr, default=None):
        ...
        elif self.has_key(unicode(attr)):
            return condJSON(self[unicode(attr)],__name__='%s\t%s'%(self.__name__,errorValue(attr)))
        elif attr=='__safe__':
...
class JSONDictSafe(JSONDict):
    ...
    def __getattr__(self, attr, default=None):
        if self.has_key(attr):
            ...
            return condJSONSafe(self[unicode(attr)],__name__='%s\t%s'%(self.__name__,errorValue(attr)))
        elif attr=='__safe__':
            return self
        else:
            return JSONStrSafe('')

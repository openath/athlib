...
__all__ = (
        ...
        'PAT_MULTI', 'PAT_FINISHED', 'PAT_NOT_FINISHED', 'PAT_PERF', 'PAT_RACES_FOR_DISTANCE', 'PAT_RELAYS', 'PAT_ROAD',
...
PAT_TRACK = re.compile(r"^(?:(?:(?P<meters>\d+|\d?MILE)\s*(?P<msfx>%s|[yY]|[wW]|[wW][cC]|[rR][rR]|[fF][rR])?)|[sS][cC]|[2345][mM][tT]|[lL][hH]|[sS][hH])$" % _)

...
:Organisation:  Organisations include Clubs, National Governing Bodies or Federations, International Federations, Regional bodies, Leagues and more.   Organisations can `affiliate` to each other.  This is often recognised by the payment of a fee.
...
We attempted to call this `discipline`, because of the many ways `event` is used, but have been informed very plainly by many leading statisticians and systems builders that this will never
...
:discipline:  we'll use this in the broader sense of which part of the sport.   TF (for track and field), ROAD, XC, WALK, MTN (for mountain)

...
// start code generated by scripts/codemaps.py Wed Apr 22 11:49:14 2020
var PAT_EVENT_CODE = /^(?:[bB][iI]|[tT][rR][iI]|[qQ][uU][aA][dD]|[pP][eE][nN]|[hH][eE][xX]|[hH][eE][pP]|[oO][cC][tT]|[eE][nN][nN]|[dD][eE][cC]|[hH][eE][nN]|[dD][oO][dD]|[iI][cC][oO]|[pP][eE][nN][iI]|[pP][eE][nN][wW][tT]|(?:(\d+)\s*([lLsS]?[hH]\s*((3[36])|(\d{2,3}\.?\d*cm)\s*(?:(\d{1,3}\.?\d*m)(?:\s*(\d{1,3}\.?\d*m))?)?)?|[sS][cC]|[yY]|[wW])?)|[sS][cC]|[2345][mM][tT]|[lL][hH]|[sS][hH]|(?:[mM][iI][lL][eE]|[mM][aA][rR]|[hH][mM])[wW]?|[xX][cC]|(?:\d{1,3}(\.\d\d?)?(?:[MKk]|[MKk][wW]|[wW]))|(\d{1,2})[xX](\d{2,5}[hH]?|[rR][eE][lL][aA][yY])|[dD][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[jJ][tT]([45678]00\s*g?|)|[hH][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][pP](\s*\d\.?\d*\s*[Kk][Gg]?|)|[wW][tT](\d?\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][sW][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[bB][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[gG][dD][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[oO][tT](\d+\s*g?|)|[Hh][1-9]|[Ll][1-9]|[sS]?[hH][jJ]|[pP][vV]|[sS]?[lL][jJ]|[sS]?[tT][jJ]|(\d{1,2})[xX](\d{2,5}[hH]?|[rR][eE][lL][aA][yY])|(\d{2,4})(?:[lLsS]?[hH]\s*((3[36])|(\d{2,3}\.?\d*cm)\s*(?:(\d{1,3}\.?\d*m)(?:\s*(\d{1,3}\.?\d*m))?)?)?|[sS][cC])|(\d\d?)([hH](?:[rR]|[wW]))|[tT](\d+))$/;
var PAT_FIELD = /^(?:[dD][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[jJ][tT]([45678]00\s*g?|)|[hH][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][pP](\s*\d\.?\d*\s*[Kk][Gg]?|)|[wW][tT](\d?\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][sW][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[bB][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[gG][dD][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[oO][tT](\d+\s*g?|)|[Hh][1-9]|[Ll][1-9])$|^(?:[sS]?[hH][jJ]|[pP][vV]|[sS]?[lL][jJ]|[sS]?[tT][jJ])$/;
...
var PAT_LENGTH_EVENT = /^(?:[sS]?[lL][jJ]|[sS]?[tT][jJ]|[dD][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[jJ][tT]([45678]00\s*g?|)|[hH][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][pP](\s*\d\.?\d*\s*[Kk][Gg]?|)|[wW][tT](\d?\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][sW][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[bB][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[gG][dD][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[oO][tT](\d+\s*g?|)|[Hh][1-9]|[Ll][1-9])$/;
...
var PAT_THROWS = /^(?:[dD][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[jJ][tT]([45678]00\s*g?|)|[hH][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][pP](\s*\d\.?\d*\s*[Kk][Gg]?|)|[wW][tT](\d?\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][sW][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[bB][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[sS][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[gG][dD][tT](\s*\d\.?\d*\s*[Kk][Gg]?|)|[oO][tT](\d+\s*g?|)|[Hh][1-9]|[Ll][1-9])$/;

...
// start code generated by scripts/codemaps.py Wed Feb 19 15:31:40 2020
var PAT_EVENT_CODE = /^(?:[bB][iI]|[tT][rR][iI]|[qQ][uU][aA][dD]|[pP][eE][nN]|[hH][eE][xX]|[hH][eE][pP]|[oO][cC][tT]|[eE][nN][nN]|[dD][eE][cC]|[hH][eE][nN]|[dD][oO][dD]|[iI][cC][oO]|[pP][eE][nN][iI]|[pP][eE][nN][wW][tT]|(?:(\d+)\s*([lLsS]?[hH]\s*((3[36])|(\d{2,3}\.?\d*cm)\s*(?:(\d{1,3}\.?\d*m)(?:\s*(\d{1,3}\.?\d*m))?)?)?|[sS][cC]|[yY]|[wW])?)|[sS][cC]|[2345][mM][tT]|[lL][hH]|[sS][hH]|(?:[mM][iI][lL][eE]|[mM][aA][rR]|[hH][mM])[wW]?|[xX][cC]|(?:\d{1,3}(\.\d\d?)?(?:[MKk]|[MKk][wW]|[wW]))|[dD][tT](\d\.?\d*\s*[Kk][Gg]?|)|[jJ][tT]([45678]00\s*g?|)|[hH][tT](\d\.?\d*\s*[Kk][Gg]?|)|[sS][pP](\d\.?\d*\s*[Kk][Gg]?|)|[wW][tT](\d?\d\.?\d*\s*[Kk][Gg]?|)|[sS][sW][tT](\d\.?\d*\s*[Kk][Gg]?|)|[bB][tT](\d\.?\d*\s*[Kk][Gg]?|)|[sS][tT](\d\.?\d*\s*[Kk][Gg]?|)|[gG][dD][tT](\d\.?\d*\s*[Kk][Gg]?|)|[oO][tT](\d+\s*g?|)||[sS]?[hH][jJ]|[pP][vV]|[sS]?[lL][jJ]|[sS]?[tT][jJ]|(\d{1,2})[xX](\d{2,5}[hH]?|[rR][eE][lL][aA][yY])|(\d{2,4})(?:[lLsS]?[hH]\s*((3[36])|(\d{2,3}\.?\d*cm)\s*(?:(\d{1,3}\.?\d*m)(?:\s*(\d{1,3}\.?\d*m))?)?)?|[sS][cC])|\d\d?([hH](?:[rR]|[wW])))$/;
var PAT_FIELD = /^(?:[dD][tT](\d\.?\d*\s*[Kk][Gg]?|)|[jJ][tT]([45678]00\s*g?|)|[hH][tT](\d\.?\d*\s*[Kk][Gg]?|)|[sS][pP](\d\.?\d*\s*[Kk][Gg]?|)|[wW][tT](\d?\d\.?\d*\s*[Kk][Gg]?|)|[sS][sW][tT](\d\.?\d*\s*[Kk][Gg]?|)|[bB][tT](\d\.?\d*\s*[Kk][Gg]?|)|[sS][tT](\d\.?\d*\s*[Kk][Gg]?|)|[gG][dD][tT](\d\.?\d*\s*[Kk][Gg]?|)|[oO][tT](\d+\s*g?|)|)$|^(?:[sS]?[hH][jJ]|[pP][vV]|[sS]?[lL][jJ]|[sS]?[tT][jJ])$/;
...
var PAT_LENGTH_EVENT = /^(?:[sS]?[lL][jJ]|[sS]?[tT][jJ]|[dD][tT](\d\.?\d*\s*[Kk][Gg]?|)|[jJ][tT]([45678]00\s*g?|)|[hH][tT](\d\.?\d*\s*[Kk][Gg]?|)|[sS][pP](\d\.?\d*\s*[Kk][Gg]?|)|[wW][tT](\d?\d\.?\d*\s*[Kk][Gg]?|)|[sS][sW][tT](\d\.?\d*\s*[Kk][Gg]?|)|[bB][tT](\d\.?\d*\s*[Kk][Gg]?|)|[sS][tT](\d\.?\d*\s*[Kk][Gg]?|)|[gG][dD][tT](\d\.?\d*\s*[Kk][Gg]?|)|[oO][tT](\d+\s*g?|)|)$/;
...
var PAT_THROWS = /^(?:[dD][tT](\d\.?\d*\s*[Kk][Gg]?|)|[jJ][tT]([45678]00\s*g?|)|[hH][tT](\d\.?\d*\s*[Kk][Gg]?|)|[sS][pP](\d\.?\d*\s*[Kk][Gg]?|)|[wW][tT](\d?\d\.?\d*\s*[Kk][Gg]?|)|[sS][sW][tT](\d\.?\d*\s*[Kk][Gg]?|)|[bB][tT](\d\.?\d*\s*[Kk][Gg]?|)|[sS][tT](\d\.?\d*\s*[Kk][Gg]?|)|[gG][dD][tT](\d\.?\d*\s*[Kk][Gg]?|)|[oO][tT](\d+\s*g?|)|)$/;
...
var __patObjs = [PAT_NOT_FINISHED, PAT_MULTI, PAT_TRACK,
  PAT_RACES_FOR_DISTANCE, PAT_THROWS, PAT_EVENT_CODE, PAT_PERF,
  PAT_FINISH_RECORD, PAT_TIMED_EVENT, PAT_ROAD, PAT_LENGTH_EVENT,
  PAT_LEADING_FLOAT, PAT_FIELD, PAT_HORIZONTAL_JUMPS, PAT_JUMPS, PAT_RUN,
  PAT_HURDLES, PAT_RELAYS, PAT_LEADING_DIGITS, PAT_VERTICAL_JUMPS,
  PAT_LONG_SECONDS];
var __patNames = ['PAT_NOT_FINISHED', 'PAT_MULTI', 'PAT_TRACK',
  'PAT_RACES_FOR_DISTANCE', 'PAT_THROWS', 'PAT_EVENT_CODE', 'PAT_PERF',
  'PAT_FINISH_RECORD', 'PAT_TIMED_EVENT', 'PAT_ROAD', 'PAT_LENGTH_EVENT',
  'PAT_LEADING_FLOAT', 'PAT_FIELD', 'PAT_HORIZONTAL_JUMPS', 'PAT_JUMPS',
  'PAT_RUN', 'PAT_HURDLES', 'PAT_RELAYS', 'PAT_LEADING_DIGITS',
  'PAT_VERTICAL_JUMPS', 'PAT_LONG_SECONDS'];
